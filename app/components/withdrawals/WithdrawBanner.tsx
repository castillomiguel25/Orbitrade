    ...
    <div className="relative space-y-6">
        ...
        <div className="inline-flex items-center gap-3 mb-2">
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 15px rgba(220, 149, 230, 0.2)',
            }}
          >
      ...
      >
        ...
        <div className="flex items-start gap-3">
          ...
          />
          <div className="font-mono text-xs text-bio-yellow/90 leading-relaxed">
            <div className="font-bold mb-1.5">{intl.formatMessage({ id: 'components.withdrawBanner.commissionTitle' })}</div>
            <div className="text-bio-yellow/70 mb-1">
              {intl.formatMessage({ id: 'components.withdrawBanner.commissionRates' })}
            </div>
            <div className="text-stellar-white/80">
              {intl.formatMessage({ id: 'components.withdrawBanner.nextWithdrawal' })} <span className="text-bio-yellow font-bold">{comisionRetiro}%</span>
              {currentWeekCount > 0 && (
                <span className="text-cosmic-gray ml-1">
                  {intl.formatMessage(
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 25px rgba(0, 245, 255, 0.1)',
        }}
      >
        {/* Corner brackets */}
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          ...
          <div className="font-mono text-[10px] text-cyber-cyan/70 uppercase tracking-wider mb-1">
            {intl.formatMessage({ id: 'components.withdrawBanner.minimumExtract' })}
          </div>
          <div className="font-display text-lg font-bold text-cyber-cyan">{limiteMinimo} USDT</div>
        </div>
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(10, 10, 15, 0.95), rgba(10, 36, 25, 0.9))',
            border: '1px solid rgba(220, 149, 230, 0.25)',
          }}
        >
          <div className="absolute top-1 left-1 w-2 h-2 border-t border-l border-plasma-pink/40 rounded-tl" />
          <div className="font-mono text-[10px] text-plasma-pink/70 uppercase tracking-wider mb-1">
            {intl.formatMessage({ id: 'components.withdrawBanner.quantumFee' })}
          </div>
          <div className="font-display text-lg font-bold text-plasma-pink">{comisionRetiro}%</div>
        </div>
        ...
        >
          <div className="absolute top-1 left-1 w-2 h-2 border-t border-l border-miner-green/40 rounded-tl" />
          <div className="font-mono text-[10px] text-miner-green/70 uppercase tracking-wider mb-1">
            {intl.formatMessage({ id: 'components.withdrawBanner.processTime' })}
          </div>
          <div className="font-display text-lg font-bold text-miner-green">24-48H</div>
        </div>
      </div>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(10, 10, 15, 0.95), rgba(10, 36, 25, 0.9))',
          border: `1px solid ${withdrawalKey ? 'rgba(19, 241, 135, 0.3)' : 'rgba(239, 68, 68, 0.3)'}`,
        }}
      >
        {/* Corner brackets */}
        <div
          className={`absolute top-1.5 left-1.5 w-2.5 h-2.5 border-t-2 border-l-2 rounded-tl ${
            withdrawalKey ? 'border-miner-green/50' : 'border-red-500/50'
          }`}
        />
        <div
        ...
        <div className="flex items-center gap-3 mb-3">
          <div
            ...
            style={{
              background: withdrawalKey
                ? 'linear-gradient(135deg, rgba(19, 241, 135, 0.3), rgba(19, 241, 135, 0.1))'
          ...
          <span
            className={`font-mono text-xs uppercase tracking-wider ${
              withdrawalKey ? 'text-miner-green' : 'text-red-400'
            }`}
          >
        ...
        <div className="space-y-3">
          ...
          <div
            ...
            style={{
              background: withdrawalKey ? 'rgba(19, 241, 135, 0.1)' : 'rgba(239, 68, 68, 0.1)',
              border: withdrawalKey ? '1px solid rgba(19, 241, 135, 0.3)' : '1px solid rgba(239, 68, 68, 0.3)',
            }}
          >
            <div
              className={`font-mono text-[10px] uppercase tracking-wider mb-1 ${
                withdrawalKey ? 'text-miner-green/70' : 'text-red-400/70'
              }`}
            >
            ...
            <div className="flex items-center justify-center gap-2">
              <div
                ...
                style={{
                  backgroundColor: withdrawalKey ? '#13f187' : '#ef4444',
                  boxShadow: withdrawalKey ? '0 0 8px #13f187' : '0 0 8px #ef4444',
                }}
              />
              <span
                className={`font-display text-sm font-bold ${withdrawalKey ? 'text-miner-green' : 'text-red-400'}`}
              >
                {withdrawalKey
      ...
      {withdrawalKey && (
        ...
        >
          {/* Corner brackets */}
          <div className="absolute top-1.5 left-1.5 w-2.5 h-2.5 border-t-2 border-l-2 border-miner-green/50 rounded-tl" />
          <div className="absolute top-1.5 right-1.5 w-2.5 h-2.5 border-t-2 border-r-2 border-miner-green/50 rounded-tr" />
          ...
          <Button onClick={abrirModal} variant="cosmic" className="w-full py-3 font-mono tracking-wider">
            <div className="flex items-center justify-center gap-2">
              <span>🚀</span>
      ...
      {!withdrawalKey && (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-sm font-bold text-bio-yellow mb-0.5">
                {intl.formatMessage({ id: 'components.withdrawBanner.securityProtocolRequired' })}
              </div>
              <div className="font-mono text-xs text-bio-yellow/70">
