  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-amber-400 to-transparent opacity-60" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-2xl p-6 border border-amber-500/25 shadow-2xl">
            
            {/* Panel Header */}
            <div className="text-center mb-4">
              <div className="inline-flex items-center gap-2 mb-2">
                
                <span className="text-[#E6E8EC] font-mono text-sm tracking-wider font-bold">{intl.formatMessage({ id: 'components.depositStep.transferAmount' })}</span>
              </div>
              <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-amber-400 to-transparent opacity-60" />
            </div>
            ...
            <div className="text-center">
              <div className="relative inline-block">
                ...
                <div className="relative bg-slate-800/90 rounded-xl px-6 py-4 border border-amber-500/30">
                  <div className="text-[#E6E8EC] font-mono text-xs tracking-widest mb-1">{intl.formatMessage({ id: 'components.depositStep.quantumFuel' })}</div>
                  <div className="text-[#E6E8EC] font-mono text-3xl font-bold tracking-wider mb-1">
                    {amount}
                  </div>
                  <div className="text-amber-400 font-mono text-sm tracking-wider">USDT</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 text-center">
              <div className="inline-flex items-center gap-2 bg-blue-500/10 px-4 py-2 rounded-full border border-blue-500/30">
                ...
                <span className="text-[#E6E8EC] font-mono text-xs font-bold">{intl.formatMessage({ id: 'components.depositStep.tronNetwork' })}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        <div className="relative rounded-2xl p-6 border border-[#7C8AA0]/25 shadow-2xl">
          
          {/* Header */}
          <div className="text-center mb-4">
            <div className="inline-flex items-center gap-2 mb-2">
              <span className="text-amber-400 text-lg">🗒️</span>
              <span className="text-amber-300 font-mono text-sm tracking-wider font-bold">{intl.formatMessage({ id: 'components.depositStep.destinationCoordinates' })}</span>
            </div>
            <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-[#7C8AA0] to-transparent opacity-60" />
          </div>
            ...
            <div className={`relative bg-slate-800/90 rounded-xl border-2 transition-all duration-500 ${
              ...
              <div className="flex items-center justify-between p-4 border-b border-slate-700/50">
                <div className="flex items-center gap-3">
                  <span className="text-amber-300 font-mono text-sm font-bold tracking-widest">{intl.formatMessage({ id: 'components.depositStep.walletAddress' })}</span>
                  {glowEffect && (
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                      <span className="text-amber-400 font-mono text-xs font-bold">{intl.formatMessage({ id: 'components.depositStep.copied' })}</span>
                    </div>
                  )}
                </div>
